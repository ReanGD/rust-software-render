...
impl Material {
    ...
    pub fn calc_ambient_intensity(&mut self) {
        const K_VEC: Vector3<f32> = Vector3::new(0.212671_f32, 0.715160_f32, 0.072169_f32);
    ...
    #[allow(dead_code)]
    pub fn silver(&mut self) -> Material {
    ...
    #[allow(dead_code)]
    pub fn monster_skin(&mut self) -> Material {
